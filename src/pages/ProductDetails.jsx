        ...
        <div className="card-body p-4">
          ...
          <div className="row">
            ...
            <div className="col-md-7">
              ...
              <div className="d-flex align-items-center justify-content-center" style={{ background: '#e9ecef', borderRadius: '8px', minHeight: '200px' }}>
                <svg width="80%" height="80%" viewBox="0 0 100 50" preserveAspectRatio="none">
                    <path d="M 0,45 Q 15,10 30,30 T 60,20 T 90,40 L 100,35" stroke="#6c757d" fill="transparent" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round"/>
                </svg>
              </div>
            </div>
            ...
            <div className="col-md-5">
              ...
              <ul className="list-group list-group-flush mt-3">
                {product.priceComparison.pricesByStore.map(store => (
                   <li key={store.id} className="list-group-item d-flex justify-content-between align-items-center px-0">
                     {store.name}
